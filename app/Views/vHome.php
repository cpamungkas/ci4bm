    ...
    <!-- <div class="row-fluid">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <div class="buttons">
                    <a href="#" class="btn btn-mini btn-success"><i class="icon-refresh"></i> Update stats</a>
                </div>
            </div>
                    ...
                    <ul class="recent-posts">
                        <li>
                            ...
                            <div class="article-post">
                                ...
                                <p>
                                    <a href="#">This is a much longer one that will go on for a few
                                        lines.It has multiple paragraphs and is full of waffle
                        ...
                        <li>
                            ...
                            <div class="article-post">
                                ...
                                <p>
                                    <a href="#">This is a much longer one that will go on for a few
                                        lines.Itaffle to pad out the comment.</a>
                                </p>
                            </div>
                        </li>
                        ...
                        <div class="panel-content nopadding">
                            <ul class="contact-list">
                                <li id="user-Sunil" class="online">
                                    <a href=""><img alt="" src="<?php echo base_url(); ?>/img/demo/av1.jpg" />
                                        <span>Sunil</span></a>
                                </li>
                                <li id="user-Laukik">
                                    <a href=""><img alt="" src="<?php echo base_url(); ?>/img/demo/av2.jpg" />
                                        <span>Laukik</span></a>
                                </li>
                                <li id="user-vijay" class="online new">
                                    <a href=""><img alt="" src="<?php echo base_url(); ?>/img/demo/av3.jpg" />
                                        <span>Vijay</span></a><span class="msg-count badge badge-info">3</span>
                                </li>
                                <li id="user-Jignesh" class="online">
                                    <a href=""><img alt="" src="<?php echo base_url(); ?>/img/demo/av4.jpg" />
                                        <span>Jignesh</span></a>
                                </li>
                                <li id="user-Malay" class="online">
                                    <a href=""><img alt="" src="<?php echo base_url(); ?>/img/demo/av5.jpg" />
                                        <span>Malay</span></a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content tab-content">
                    <div id="tab1" class="tab-pane active">
                        ...
                        <img src="<?php echo base_url(); ?>/img/demo/demo-image1.jpg" alt="demo-image" />
                    </div>
                    <div id="tab2" class="tab-pane">
                        <img src="<?php echo base_url(); ?>/img/demo/demo-image2.jpg" alt="demo-image" />
                        <p>
                            And is full of waffle to It has multiple paragraphs and is
                            full of waffle to pad out the comment. Usually, you just
                            wish these sorts of comments would come to an end.multiple
                    ...
                    <div id="tab3" class="tab-pane">
                        ...
                        <img src="<?php echo base_url(); ?>/img/demo/demo-image3.jpg" alt="demo-image" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding fix_hgt">
                    <ul class="recent-posts">
                        <li>
                            <div class="user-thumb">
                                <img width="40" height="40" alt="User" src="<?php echo base_url(); ?>/img/demo/av1.jpg" />
                            </div>
                            <div class="article-post">
                        ...
                        <li>
                            <div class="user-thumb">
                                <img width="40" height="40" alt="User" src="<?php echo base_url(); ?>/img/demo/av2.jpg" />
                            </div>
                            <div class="article-post">
                                <span class="user-info">John Deo</span>
                                <p>Web Desginer &amp; creative Front end developer</p>
                        ...
                        <li>
                            <div class="user-thumb">
                                <img width="40" height="40" alt="User" src="<?php echo base_url(); ?>/img/demo/av4.jpg" />
                            </div>
                            <div class="article-post">
                                <span class="user-info">John Deo</span>
                                <p>Web Desginer &amp; creative Front end developer</p>
            ...
            <div class="accordion" id="collapse-group">
                <div class="accordion-group widget-box">
                    ...
                    <div class="collapse in accordion-body" id="collapseGOne">
                        <div class="widget-content">
                            It has multiple paragraphs and is full of waffle to pad out
                ...
                <div class="accordion-group widget-box">
                    ...
                    <div class="collapse accordion-body" id="collapseGThree">
                        <div class="widget-content">
                            Waffle to It has multiple paragraphs and is full of waffle
