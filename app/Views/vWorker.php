...
<head>
    ...
    <!--[if lte IE 9]>
			<link rel="stylesheet" href="worker_assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
		<![endif]-->
    <link rel="stylesheet" href="worker_assets/css/ace-skins.min.css" />
    <link rel="stylesheet" href="worker_assets/css/ace-rtl.min.css" />

    <!--[if lte IE 9]>
		  <link rel="stylesheet" href="worker_assets/css/ace-ie.min.css" />
		<![endif]-->
    ...
    <!--[if lte IE 8]>
		<script src="worker_assets/js/html5shiv.min.js"></script>
		<script src="worker_assets/js/respond.min.js"></script>
		<![endif]-->
</head>
...
<body class="no-skin skin-3">
    ...
    <div class="main-container ace-save-state" id="main-container">
        ...
        <div id="sidebar" class="sidebar      h-sidebar                navbar-collapse collapse          ace-save-state menu-min sidebar-fixed" data-sidebar="true" data-sidebar-scroll="true" data-sidebar-hover="true" style="margin-top: 17px;">
            <script type=" text/javascript">
                try {
